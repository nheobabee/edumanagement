        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="container">
                        <br>
                        <a href=""><button class="btn btn-success"> ADD PROJECT</button></a>
                        <?php
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href=""><button type="button" class="btn btn-primary text-white me-2"><i class="fas fa-user-edit"></i></button></a>
                                            </td>

                                            <td>
                                                <a href=""><button type="button" class="btn btn-danger text-white me-2"><i class="fas fa-user-minus"></i></button></a>
                                            </td>
                                        </tr>
                                <?php
                                    }
