                        ...
                        <form method="post">
                            ...
                            ?>
                              <div class="form-group">
                                <label class = "subMH" for="idMH">ID Subject : <span style="font-weight:500"><?php echo $nameMH ?><span></label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="deadlineBTVN" placeholder="Enter deadline" name="deadlineBTVN">
                            </div>
                            <div class="form-group">
